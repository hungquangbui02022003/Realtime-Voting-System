...
if __name__ == "__main__":
    ...
    spark = (SparkSession.builder
         ...
         .master("local[*]")
         .config("spark.jars.packages", "org.apache.spark:spark-sql-kafka-0-10_2.12:3.5.2,org.scala-lang:scala-library:2.12.12")
         .config("spark.jars", r"C:\Users\ACER\Downloads\Personal_Project\Realtime_Voting_System\postgresql-42.7.1.jar")
    ...
    votes_per_candidate_to_kafka = votes_per_candidate.selectExpr("to_json(struct(*)) AS value") \
        ...
        .option("checkpointLocation", "C/Users/ACER/Downloads/Personal_Project/Realtime_Voting_System/checkpoints/checkpoint1") \
        .outputMode("update") \
        .start()
    ...
    turnout_by_location_to_kafka = turnout_by_location.selectExpr("to_json(struct(*)) AS value") \
        ...
        .option("checkpointLocation", "C/Users/ACER/Downloads/Personal_Project/Realtime_Voting_System/checkpoints/checkpoint2") \
        .outputMode("update") \
        .start()
